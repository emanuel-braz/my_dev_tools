...
import { ANDROID_DEEPLINK_EXT, IOS_DEEPLINK_EXT, LAST_PROMPT_EXT, CLEAR_CACHE_EXT, IOS_PUSH_NOTIFICATION_EXT, ANDROID_PUSH_NOTIFICATION_EXT, PUSH_NOTIFICATION_LAST_USED_EXT, ANDROID_MIRROR_SCREEN_EXT, START_AVD_EXT, CONNECT_WIFI_EXT, DISCONNECT_WIFI_EXT, SHOW_DEVICES_EXT } from './core/consts/extensions';
...
export function activate(context: ExtensionContext) {
	...
	// Manage Device
	context.subscriptions.push(commands.registerCommand(START_AVD_EXT, async () => deviceDelegate.startAvd(context)));
	...
	context.subscriptions.push(commands.registerCommand(SHOW_DEVICES_EXT, async () => deviceDelegate.showConnectedDevices(context)));
}